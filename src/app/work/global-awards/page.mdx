...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://samcreations.uk/work/global-awards',
  },
  keywords: [
    'tailor of the year award',
    'luxury tailoring London',
    'award winning tailor UK',
    'high fashion garment manufacturing',
    'precision tailoring craftsmanship',
    'bespoke tailoring excellence',
    'international tailoring recognition',
  ],
}
