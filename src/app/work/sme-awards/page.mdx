...
export const metadata = {
  ...
  alternates: {
    canonical:
      'https://samcreations.uk/work/sme-awards',
  },
  keywords: [
    'sustainable garment manufacturing London',
    'eco conscious fashion manufacturer',
    'upcycled clothing production UK',
    'made to order fashion studio',
    'sustainable womenswear manufacturing',
    'ethical fashion production London',
    'award winning sustainable manufacturer',
  ],
}
