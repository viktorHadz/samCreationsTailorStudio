import logo from '@/images/awards/kat-rose-logo.webp'
import imageHero from '@/images/awards/kat-rose-hero.webp'

export const caseStudy = {
  client: 'Kat & Rose Boutique',
  title: 'Launching Our Eco-Conscious Fashion Brand',
  description:
    'Successfully launched Kat & Rose, our own sustainable womenswear brand, combining 25 years of tailoring expertise with innovative eco-conscious practices including upcycled collections and made-to-order production.',
  summary: [
