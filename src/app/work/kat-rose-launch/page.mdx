...
export const caseStudy = {
  ...
  description:
    'Successfully launched Kat & Rose, our own sustainable womenswear brand, combining over 20 years of tailoring expertise with innovative eco-conscious practices including upcycled collections and made-to-order production.',
  summary: [
    'Launched sustainable womenswear brand as a counter to fast fashion waste.',
...
export const metadata = {
  title: `${caseStudy.title} | S.A.M. Creations`,
  description: caseStudy.description,
  alternates: {
    canonical: 'https://samcreations.uk/work/kat-rose-launch',
  },
  keywords: [
    'sustainable fashion brand London',
    'upcycled womenswear UK',
    'made to order clothing production',
    'eco friendly garment manufacturing',
    'ethical tailoring London',
    'sustainable womenswear launch',
    'slow fashion brand development',
  ],
}
